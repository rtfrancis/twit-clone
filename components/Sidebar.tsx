...
function Sidebar() {
  return (
    <div className="fixed hidden h-full flex-col items-center p-2 sm:flex xl:w-[340px] xl:items-start">
      ...
      <div className="hoverAnimation mt-auto flex items-center justify-center text-[#d9d9d9] xl:ml-auto">
        <img
        ...
        <div className="hidden leading-5 xl:inline">
          <h4 className="font-bold">rtfrancis</h4>
          <p className="text-[#6e767d]">@rtfrancis</p>
        </div>
